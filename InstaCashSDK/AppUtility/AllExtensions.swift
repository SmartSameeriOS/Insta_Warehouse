...
class GlobalUtility: NSObject {
    ...
    //var AppThemeColor : UIColor = UIColor().HexToColor(hexString: "#008F00", alpha: 1.0)
    //var AppThemeColor = #colorLiteral(red: 0, green: 0.5607843137, blue: 0, alpha: 1)
    
    //var AppThemeColor = #colorLiteral(red: 0, green: 0.6117647059, blue: 0, alpha: 1)
